...
# global variables
url="https://raw.githubusercontent.com/alexandershalin/rclone_script"
branch="master"
...
backtitle="RCLONE_SCRIPT installer (https://github.com/alexandershalin/rclone_script)"
...
function 5aRUNCOMMAND-ONSTART ()
{
	...
	then
		...
		then
			...
			sudo chown pi:pi /opt/retropie/configs/all/runcommand-onstart.sh # Permissions fix
...
function 5aRUNCOMMAND-ONEND ()
{
	...
	then
		...
		then
			...
			sudo chown pi:pi /opt/retropie/configs/all/runcommand-onend.sh # Permissions fix
