...
# global variables
url="https://raw.githubusercontent.com/ds17f/rclone_script"
branch="master"
...
backtitle="RCLONE_SCRIPT installer (https://github.com/ds17f/rclone_script)"
